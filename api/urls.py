...
from api.views import (AffiliationViewSet, CharacterViewSet, DomainViewSet,
                       ...
                       QuestViewSet, RaceViewSet, SaleViewSet, SkillViewSet,
...
urlpatterns = [
    ...
    path('domain/<int:domain_id>/details',
         DomainViewSet.get_domain_details, name="get_domain_details"),
    path('domain/<int:domain_id>/character/<int:character_id>/',
         DomainViewSet.get_character_domain_data, name="get_character_domain_data"),
]
