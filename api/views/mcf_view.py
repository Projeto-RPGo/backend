...
from ..serializers.mcf_serializer import MCFSerializer


class MCFViewSet(viewsets.ModelViewSet):
    """
    ...
    queryset = MCF.objects.all().order_by('-name')
    serializer_class = MCFSerializer
